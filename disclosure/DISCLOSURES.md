...
|---|---|---|
| `qwen2.5-coder:3b-instruct-q2_K` / `q3_K_S` / `q3_K_M` / `q3_K_L` (bad conversion batch) | Ollama official library | issue link pending, filed as one report covering the batch |
| `phi3.5:3.8b-mini-instruct-q2_K` (isolated bad conversion) | Ollama official library | included in the same report |
